...
export const SEMINAR_BERKAS_ITEMS: string[] = [
  ...
  "Lulus Mata Kuliah Wajib, minimal telah menempuh dan lulus 30 SKS / asli transkrip ditandatangani Direktur",
  "Form asli penjadwalan persetujuan pelaksanaan Seminar",
  "Fotokopi kwitansi pembayaran SMTR 3, awal dan pelunasan",
  "Bukti mengikuti/menghadiri 10 kali pelaksanaan Seminar Proposal",
  "Fotokopi proposal tesis yang sudah ditandatangani pada lembar persetujuan (4 rangkap)",
...
/** Folder Google Drive berisi template berkas Seminar Proposal. */
export const SEMINAR_TEMPLATE_URL =
  "https://drive.google.com/drive/folders/1StM6fL0-sDIPq9dGEQwMeT47J5Bu67IG?usp=drive_link";
